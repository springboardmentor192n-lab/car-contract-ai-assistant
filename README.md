...
## 🚀 Deployment
The AutoFinance Guardian project is deployed at:  
🔗 https://autofinance-guardian.web.app/
...
Flutter App → FastAPI Backend → PostgreSQL → AI Services
...
After pasting both corrected files:

```bash
git add .
git commit -m "Resolved merge conflicts in README and main.py"
git push origin AI_CarAssistant-Deepali
